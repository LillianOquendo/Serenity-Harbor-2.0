        ...
        <div className="w-1/2  m-20">
            ...
            <div>
                ...
                <div className="p-5 flex flex-col items-center text-center group cursor-default">
                    ...
                    Physical abuse is any intentional, unwanted contact with you or something close to your body,
                ...
                <div className="grid grid-cols-5 group bg-white rounded-tl-3xl rounded-tr-3xl rounded-br-3xl rounded-bl-3xl">
                    ...
                    If they pull your hair or punch, slap, kick, bite, choke, or smother you: These are direct physical acts of violence and harm.
                    </p>
                    </div>

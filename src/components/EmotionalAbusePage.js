        ...
        <div className="w-1/2  m-20">
            ...
            <div>
                ...
                <div className="p-5 flex flex-col items-center text-center group cursor-default">
                    ...
                    Emotional abuse includes non-physical behaviors such as threats, insults, constant monitoring or 'checking-in,'
                ...
                <div className="grid grid-cols-5 group bg-white rounded-tl-3xl rounded-tr-3xl rounded-br-3xl rounded-bl-3xl">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                    Gaslighting involves manipulating your perception of reality and can lead to confusion, self-doubt, and emotional turmoil.
                    </p>
                    </div>

        ...
        <div>
            ...
            <div className="p-5 flex flex-col items-center text-center group cursor-default">
                ...
                Sexual Abuse refers to any behavior that pressures or
                    ...
                    person's ability to control their sexual activity or the
                    circumstances in which sexual activity takes place,
            ...
            <div className="grid grid-cols-5 group bg-white rounded-tl-3xl rounded-tr-3xl rounded-br-3xl rounded-bl-3xl">
                ...
                Force or manipulate you into having sex or performing
                      ...
                      physically injured from their abuse.
                </p>
                </div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                Hurt you with weapons or objects during sex without consent.
                </p>
                </div>
